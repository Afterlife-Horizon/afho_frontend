	...
	({ className, ...props }, ref) => (
		<AlertDialogPortal>
			...
			<AlertDialogPrimitive.Content
				ref={ref}
				className={cn("fixed z-50 grid w-full max-w-lg scale-100 gap-4 border bg-pallete1 text-white p-6 opacity-100 shadow-lg fade-in-90 sm:rounded-lg md:w-full", className)}
				{...props}
			/>
		</AlertDialogPortal>
	)
